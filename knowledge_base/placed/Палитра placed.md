...
- Для `Signature` сначала нужно определить стратегию цвета паспарту, затем рассчитать целевой цвет и выбрать ближайший цвет из допустимого подмножества палитры placed.
